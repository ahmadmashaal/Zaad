...
CREATE TABLE assignment_submissions (
    ...
    FOREIGN KEY (assignment_id) REFERENCES assignments(assignment_id) ON DELETE CASCADE,  -- Keep this cascading action
    FOREIGN KEY (student_id) REFERENCES users(user_id) ON DELETE NO ACTION  -- No cascading action here
);
...
CREATE TABLE exam_results (
    ...
    feedback VARCHAR(MAX),
    FOREIGN KEY (exam_id) REFERENCES exams(exam_id) ON DELETE CASCADE,  -- Keep this cascading action
    FOREIGN KEY (student_id) REFERENCES users(user_id) ON DELETE NO ACTION  -- Change to NO ACTION to prevent cascading conflicts
);
...
CREATE TABLE enrollments (
    ...
    FOREIGN KEY (student_id) REFERENCES users(user_id) ON DELETE NO ACTION,  -- Change to NO ACTION to prevent cascading conflicts
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE CASCADE,  -- Keep this cascading action
...
CREATE TABLE coupons (
    ...
    created_at DATETIME DEFAULT GETDATE(),
    updated_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE NO ACTION,  -- Changed to NO ACTION
...
CREATE TABLE wishlists (
    ...
    course_id INT NOT NULL,
    created_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (student_id) REFERENCES users(user_id) ON DELETE NO ACTION,  -- Changed to NO ACTION
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE CASCADE,
...
CREATE TABLE certificates (
    ...
    course_id INT NOT NULL,  -- Link to the course
    certificate_url VARCHAR(255) NOT NULL UNIQUE,
    issued_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (enrollment_id) REFERENCES enrollments(enrollment_id) ON DELETE CASCADE,
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE NO ACTION  -- Changed to NO ACTION to prevent cascading conflicts
);
...
CREATE TABLE announcements (
    ...
    updated_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE CASCADE,
    FOREIGN KEY (instructor_id) REFERENCES users(user_id) ON DELETE NO ACTION,  -- Changed to NO ACTION
...
CREATE TABLE messages (
    ...
    FOREIGN KEY (receiver_id) REFERENCES users(user_id) ON DELETE NO ACTION,  -- Changed to NO ACTION
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE NO ACTION,  -- Changed to NO ACTION to prevent cascading conflicts
...
CREATE TABLE user_activity (
    ...
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,  -- Keep this cascading action
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE NO ACTION,  -- NO ACTION to prevent cascading conflicts
    FOREIGN KEY (lesson_id) REFERENCES lessons(lesson_id) ON DELETE NO ACTION  -- Changed to NO ACTION
);
...
CREATE TABLE questions (
    ...
    created_at DATETIME DEFAULT GETDATE(),
    updated_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE CASCADE,  -- Keep cascading action
    FOREIGN KEY (lesson_id) REFERENCES lessons(lesson_id) ON DELETE NO ACTION,  -- Changed to NO ACTION
    FOREIGN KEY (student_id) REFERENCES users(user_id) ON DELETE NO ACTION,  -- NO ACTION to prevent cascading conflicts
